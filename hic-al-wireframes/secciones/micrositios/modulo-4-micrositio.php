<section id="micrositio-modulo4" class="columns h-a p-md-2  color-complement-1-bg">
<div class="row h-a">
     ...
     for ($i=0; $i < 8; $i++):
       ...
       <article id="micrositio-modulo4-entrada" class="columns p-0 h-15-v card color-neutral-2-bg">

         <a href="#" class="columns p-0 h-15-v color-text">
           ...
           <div class="columns p-0-2 large-7 h-100">
             ...
             <div class="columns p-0 h-15 ">
               ...
               <div class="columns p-0 p-t-0-2 h-a text-right font-xs">
             ...
             <div id="micrositio-portada-titulo" class="columns p-0 h-85 v-center">
               ...
               <h6 class="columns h-1 p-1 text-left font-m-s">
